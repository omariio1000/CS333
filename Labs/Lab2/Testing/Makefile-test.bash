...
build()
{
    ...
    make all > /dev/null
    if [ -e ${PROG} -a -e ${PROG}.o ]
    then
        ((MAKE_POINTS+=7))
    else
        echo "'make all' does not build both ${PROG} and ${PROG}.o you need to fix this to continue"
        exit 1
    fi
...
#    ((MAKE_POINTS+=5))
    ...
    echo "** Makefile points: ${MAKE_POINTS} of 35 **"
